...
public interface Duration extends Comparable<Duration> {
   ...
   * <i>format specifiers</i>; this method returns a new string in
   * which the format specifiers are replaced by representations of
   * the indicated value for {@code this} duration.
   *
