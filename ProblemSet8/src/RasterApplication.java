...
/**
 * The raster application framework encapsulates the process of rendering a single image to a window
 * on the screen.  To use this framework: <ol> <li>Extend the {@link RasterApplication} class.
 * <li>Write a main method that creates an instance of your subclass and launches it, specifying the
 * window title and dimensions:
 * <pre><code>public static void main(String[] args) {
 *   new MyRasterApplication().launch("Title", 800, 600);
 * }</code></pre>
 * </li> <li> Override method {@link #render(Raster)} to do the actual rendering. For more details
 * about what this means, see the documentation for {@link #render(Raster) render} below. </li>
 * </ol>
 */
public abstract class RasterApplication {
  ...
  /**
   * Launches the application with the given window title and dimensions. Calling this more than
